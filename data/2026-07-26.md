...
### [7] [Monte Carlo Studies of Twisted Bilayer Graphene: Strain and Thermal Fluctuations](https://arxiv.org/abs/2607.20619)
...
### [8] [Colloquium: Semi-Dirac Fermions in Quantum Matter](https://arxiv.org/abs/2607.20627)
...
### [9] [Ferromagnetic transition in a chiral spin chain](https://arxiv.org/abs/2607.20629)
...
### [10] [Doping-induced Ferromagnetic order and its unusual evolution to Helical Antiferromagnetic Order in Sr(Ni$_{1-x}$Co$_x$)$_2$P$_2$](https://arxiv.org/abs/2607.20663)
...
### [11] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [12] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [13] [Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157)
...
### [14] [Long-wavelength density response and momentum resolution in strange-metal charge spectroscopy](https://arxiv.org/abs/2607.21206)
*Ilmo Sung*
...
### [15] [Shiba duality and $η$-altermagnetism: Pairing and charge orders in bipartite attractive Hubbard models](https://arxiv.org/abs/2607.21430)
*Yu-Ping Lin*
...
### [16] [Interlayer interactions reshape charge-density wave through electronic elasticity in 4H$_{\mathrm{b}}$-TaS$_2$](https://arxiv.org/abs/2607.21470)
...
### [17] [Pseudogap formation in the moderate correlated layered attractive Hubbard model](https://arxiv.org/abs/2607.21478)
...
### [18] [Strong correlations and local self-energies from on-site ensembles](https://arxiv.org/abs/2607.21490)
...
### [19] [Symmetry and Quantum Geometry in Bloch Bands](https://arxiv.org/abs/2607.21581)
...
### [20] [Lithium-Projected Phonon Spectral Distributions as Robust Descriptors of Ionic Conductivity in Solid Electrolytes](https://arxiv.org/abs/2607.20591)
...
### [21] [Uni-XAS: Alignment-Driven Bidirectional Multimodal Learning for X-ray Absorption Spectroscopy](https://arxiv.org/abs/2607.20906)
...
### [22] [Magnetic ground states of CrPS$_4$ and NiPS$_3$ monolayers from long-range exchange interactions](https://arxiv.org/abs/2607.20631)
...
### [23] [Machine learning based prediction of optical properties in two-dimensional Mo-W-S-Se-Te transition-metal dichalcogenide alloys through physics-informed sampling](https://arxiv.org/abs/2607.21246)
...
### [24] [A high-dimensional neural network potential for finite-temperature phenomena in NiTi martensite](https://arxiv.org/abs/2607.20681)
...
### [25] [Analytical Forces from the Bethe-Salpeter Equation for Large-Scale Excited-State Relaxation](https://arxiv.org/abs/2607.20728)
...
### [26] [First-principles calculation of electron-phonon spectral functions for defects using phonon interpolation](https://arxiv.org/abs/2607.20788)
...
### [27] [Photo-induced currents and short-term memory for reservoir computing in a ferroelectric semiconductor](https://arxiv.org/abs/2607.20810)
...
### [28] [MatDiffract: A Material-Informed Automated Analysis Platform for X-ray Powder Diffraction](https://arxiv.org/abs/2607.20880)
...
### [29] [Long- and Short-Range Anion Order in SrTiO$_{3-x}$H$_x$ Perovskite Oxyhydrides: DFT+$U$ Sensitivity and HSE06 Cluster Expansion](https://arxiv.org/abs/2607.20885)
...
### [30] [Orbital Hall Effect Enables Field-Free Magnetization Reversal in Ferrimagnets without Additional Conversion Layer](https://arxiv.org/abs/2607.20888)
...
### [31] [First-Principles Analysis of Chirality-Induced Spin Selectivity at Molecule-Metal Interfaces in Photoemission](https://arxiv.org/abs/2603.22725)
...
### [32] [Visualizing Microwave-Driven Dynamics of Antiskyrmions and Surface Skyrmions](https://arxiv.org/abs/2607.20904)
...
### [34] [Complete Raman Tensor Determination in Birefringent $β$-Ga$_2$O$_3$ by Single-Stage Hyperspectral Analysis of Polarization Angle-Resolved Raman Spectra](https://arxiv.org/abs/2607.21045)
...
### [35] [Tunnel magnetoresistance effect with a Cr-doped $\mathrm{RuO_{2}}(110)$ altermagnet](https://arxiv.org/abs/2607.21092)
...
### [36] [Magneto-Caloric effect and Multiple magnetic phases in Al doped Ni2MnSn0.75Al0.25 Heusler Alloys](https://arxiv.org/abs/2607.21181)
...
### [37] [A framework for general discrete probability calculations](https://arxiv.org/abs/2607.21011)
...
### [42] [Driven criticality links universal computation and optimal representations](https://arxiv.org/abs/2607.21232)
...
### [43] [Entanglement asymmetry and quantum Mpemba effect for Kramers-Wannier duality](https://arxiv.org/abs/2607.21226)
...
### [44] [Thermal pseudo-transitions in a frustrated spin-pseudospin sawtooth chain](https://arxiv.org/abs/2607.21359)
...
### [45] [Free-volume origin of diverging direct correlations in hard crystals: insights from an exact one-dimensional model](https://arxiv.org/abs/2607.21379)
...
### [46] [Optimal feedback control under stepwise equilibration and partial observation](https://arxiv.org/abs/2607.21523)
...
### [63] [Importance-Sampling Estimation of Gaussian Molecular Shape Overlap: Exact Union Volumes and Confidence-Bounded Virtual Screening](https://arxiv.org/abs/2607.20766)
...
### [64] [Determination of fundamental properties of nitrogen from first principles. I. Atomic polarizabilities and long-range dispersion coefficients](https://arxiv.org/abs/2607.21172)
...
### [65] [Determination of fundamental properties of nitrogen from first principles. II. Interaction potential and spectroscopic properties of N$_2$](https://arxiv.org/abs/2607.21212)
...
### [66] [Determination of fundamental properties of nitrogen from first principles. III. Temperature and frequency dependence of the molecular polarizability and magnetic susceptibility](https://arxiv.org/abs/2607.21261)
...
### [67] [Graph Neural Network Force Fields (GPTFF-mol) for Organic Molecules from Optimization Trajectories (OpenGEM26)](https://arxiv.org/abs/2607.21369)
...
### [68] [Polaritons of inherently interacting molecules](https://arxiv.org/abs/2607.21389)
...
### [69] [Towards more accurate natural orbital functional approximations: including 4-index cumulant contributions](https://arxiv.org/abs/2607.21399)
...
### [70] [Approximating committor functions: Objective functions and training data sampling](https://arxiv.org/abs/2607.21425)
...
### [71] [Axel Dieter Becke: Not just the "B" in "B3LYP"](https://arxiv.org/abs/2607.21465)
*Mark Earl Casida*
